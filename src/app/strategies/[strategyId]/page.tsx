    ...
    const queryDetails = async () => {
        try {
            ...
            if (data) {
              ...
              info.profit_percentage = parseInt(info.base_total) === 0
                ? 0
      ...
      <div className="box">
        ...
        <div className="columns">
          <div className="column">
            <p>Single Purchase Amount: <span>{details.base_limit} {details.base}</span></p>
            <p>Total Purchased: <span>{details.base_total} {details.base}</span></p>
            <p className={fontColor}>
              Current Value: <span>{details.price_total} {details.base}</span></p>
          </div>
          <div className="column">
            <p>Creation Time: <span>{details.created_at}</span></p>
            <p>Quantity Bought: <span>{details.quote_total} {details.quote}</span></p>
            <p className={fontColor}>
              Profit: <span>{details.profit} {details.base}</span></p>
          </div>
          <div className="column">
            <p>Stop Profit Rate: <span>{details.stop_profit_percentage||0} %</span></p>
            <p>Current Price: <span>{details.price_usd} {details.base}</span></p>
            <p className={fontColor}>
              Profit Rate: <span>{details.profit_percentage} %</span></p>
          </div>
        </div>
        {orders.length > 0 && (
          <Chart 
